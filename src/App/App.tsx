...
const keycloakUrl = "http://localhost:8085";
const keycloakRealm = "fourpoint";
const keycloakClient = "frontend";
      ...
      <header className="App-header">
        {oidcClient.isUserLoggedIn ? (
          <>
            ...
            <button
              style={{ padding: "8px 16px", borderRadius: "8px", fontSize: 24 }}
              onClick={() => oidcClient.logout({ redirectTo: "home" })}
            >
              Logout
            </button>
          </>
